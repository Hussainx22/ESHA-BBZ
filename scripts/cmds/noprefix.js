const fs = require('Esha bby//please add music or video and move that all file inside scripts/cmdsnonprefix and replace that music name in the code or vdo if you want toset vdo just replace .mp3 with .mp4
...
case "prefix2":
  ...
  case "owner":
message.reply({
body: "———»ADMIN BOT«———\n❯ Bot Name: Esha bby\n❯ Bot Owner:HUSSAIN ꋂョ o.O\n❯ Age: 16 \n❯ Gender: Male\n❯ Facebook: https://www.facebook.com/profile.php?id=100071009500533\n❯ Total Group: 12\n❯ Total Users:none\n❯ Bot Prefix:! \n❯ Today is: Monday,February 5, 2024 3:33 PM\n❯ Thanks for using ESHA BOT",
            attachment: fs.createReadStream("scripts/cmds/noprefix/goodnight.gif"),
          });
          await api.setMessageReaction("😙", event.messageID, event.threadID, api);
   default:
